<template>
      <button @mousedown="downloadFile" class="relative inline-flex items-center justify-center p-0.5 mb-10 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-blue-900 to-purple-900 group-hover:from-blue-900 group-hover:to-purple-900 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800" :class="{'w-full':fullwidth}">
